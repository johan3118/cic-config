...
export default function Home() {
  ...
  const headers = ['ID', 'NOMBRE', 'CORREO','PROGRAMA', 'CALIFICACION'];
  
  const data = [
    { ID: 1000000, NOMBRE: 'Gleidy Joselin Espinal Hernandez', CORREO: 'GleidyEspinal@gmail.com', PROGRAMA: 'IDS', CALIFICACION: 100},
    { ID: 1000000, NOMBRE: 'Gleidy Joselin Espinal Hernandez', CORREO: 'GleidyEspinal@gmail.com', PROGRAMA: 'IDS', CALIFICACION: 100}, 
    { ID: 1000000, NOMBRE: 'Gleidy Joselin Espinal Hernandez', CORREO: 'GleidyEspinal@gmail.com', PROGRAMA: 'IDS', CALIFICACION: 100}, 
    { ID: 1000000, NOMBRE: 'Gleidy Joselin Espinal Hernandez', CORREO: 'GleidyEspinal@gmail.com', PROGRAMA: 'IDS', CALIFICACION: 100}, 
    { ID: 1000000, NOMBRE: 'Gleidy Joselin Espinal Hernandez', CORREO: 'GleidyEspinal@gmail.com', PROGRAMA: 'IDS', CALIFICACION: 100}, 
    ...
    return (
      <div className="mx-20">
        ...
        <div id="ParteTablas" className=" w-full h-2/3 flex justify-center items-center py-6">
            <TablaCalificacion headers={headers} data={data}/>
        </div>
      </div>
      
      // <main className=" text-3xl">
      //   <button className="w-screen h-screen flex justify-center items-center">
      //     <Link href="/">Pagina en proceso - Publicar Calificaciones </Link>
      //   </button>
      // </main>
    )
  }